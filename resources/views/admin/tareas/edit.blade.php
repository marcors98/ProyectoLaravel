...
@section('contenido')
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('tareas.update', $tareas -> id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    ...
                    <input type="text" name="id_user" class="form-control" value="{{ $tareas -> id_user }}"></input>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="estado" class="form-control" data-toggle="dropdown" aria-expanded="false">
                        <option value="{{ $tareas -> estado }}" class="dropdown-item" role="presentation">{{ $tareas -> estado }}</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fecha" class="form-control" value="{{ $tareas -> fecha }}"></input>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="descripcion" class="form-control" value="{{ $tareas -> descripcion }}"></input>
                </div>
